...
export const enum Constant {
    ...
    DeadClickLayer = "clarity-dead-click",
    RageClickLayer = "clarity-rage-click",
    PointerLayer = "clarity-pointer",
    TouchLayer = "clarity-touch",
    DeadTouchLayer = "clarity-dead-touch",
    RageTouchLayer = "clarity-rage-touch",
    ...
    DeadClickRing = "clarity-dead-click-ring",
    RageClickRing = "clarity-rage-click-ring",
    TouchRing = "clarity-touch-ring",
    DeadTouchRing = "clarity-dead-touch-ring",
    RageTouchRing = "clarity-rage-touch-ring",
    Title = "title",
    Round = "round",
